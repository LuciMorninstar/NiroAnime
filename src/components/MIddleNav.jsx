...
const MiddleNav = () => {
  return (
       <div className = "middle-nav flex-centered gap-[10px] relative x">

              <div className = "flex-centered hide " >
